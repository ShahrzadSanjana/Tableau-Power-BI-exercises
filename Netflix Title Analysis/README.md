...
Rather than calling it a day after building out a dashboard, I wanted to go one step further with this project and put myself in the shoes of an Analyst at Netflix and provide a few recommendations/actions to a fictitious senior executive in order to spur business performance – thereby allowing me to also demonstrate business acumen via my economics/business background.

To this end, I downloaded this dataset of Netflix Titles in .CSV format from Kaggle, cleaned it using the Data Cleaning techniques described below, and then created my visualizations and dashboard with KPI’s. 
...
![screenshot](https://user-images.githubusercontent.com/78444311/148698513-e8a95534-d8f4-46c6-a71e-ca0600591d61.jpg)
